...
export const TarjetaPizza = ({ img, name, description, price, ingredients }) => {
  ...
  <button className="btn btn-warning border-warning text-dark flex-fill py-2 see-more">
    <i className="fas fa-eye me-2"></i> Ver más
  </button>
  <button className="btn btn-success border-success text-white flex-fill py-2 add-to-cart">
